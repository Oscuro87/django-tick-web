...
\begin{itemize}
	...
	\item{Classes vue: La vue est une classe dérivant de la classe parente "<ModelView">, la vue devient alors un objet python à part entière, et son comportement peut-être modifié via la redéfinition des méthodes de la classe parente.}
\end{itemize}
