    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(default='NOT SET!', max_length=30, verbose_name='first name')),
                ('last_name', models.CharField(default='NOT SET!', max_length=30, verbose_name='last name')),
